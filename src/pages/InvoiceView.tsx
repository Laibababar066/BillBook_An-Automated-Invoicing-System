...
export default function InvoiceView() {
  ...
  const { brand, clients, invoices, updateInvoice, deleteInvoice } = useApp();
      ...
      <div className="animate-fade-up pb-20 md:pb-0">
        <div className="flex flex-col sm:flex-row items-start sm:items-center justify-between gap-4 mb-6">
          ...
          <div className="flex flex-wrap items-center gap-2">
            ...
            <button onClick={handleDelete} className="flex items-center gap-2 border border-destructive/30 text-destructive px-5 py-2.5 rounded-full font-body text-sm font-medium hover:bg-destructive/10 transition-colors">
